...
function speakThis(message) {
    ...
    if(message.includes('hi') || message.includes('hello')) {
        ...
        const finalText = "I am fine, I hope your fine";
        speech.text = finalText;
    }

    else if(message.includes('name') || message.includes('who are you ?')) {
        const finalText = "My name is A1 Assistant";
        speech.text = finalText;
    }
    ...
    else if(message.includes('search') || message.includes('search in youtube')) {
